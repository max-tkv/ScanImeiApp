...
public class RegexServiceTests : BaseUnitTests
{
    private string[] patterns =
    {
        ...
        "\\]ME\\[:?(\\d{15}):?(\\d{15})?", // ]IME[000000000000000 or }IME{000000000000000111111111111111
        "\\[ME\\[:?(\\d{15}):?(\\d{15})?", // [IME[000000000000000 or }IME{000000000000000111111111111111
        "IME\\[:?(\\d{15}):?(\\d{15})?", // IME[000000000000000 or IIME{000000000000000111111111111111
        "IME\\]:?(\\d{15}):?(\\d{15})?", // IME[000000000000000 or IIME{000000000000000111111111111111
    ...
    [InlineData("IME]:868414021570639:868414021595883:OK", "868414021595883,868414021570639")]
